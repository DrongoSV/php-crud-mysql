    ...
    <div class="container">
        ...
        <form method="POST" action="">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Ваша фамилия" value="<?php echo $first_name; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="last_name" class="col-sm-3 col-form-label">Имя</label>
                <div class="col-sm-7">
                <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Ваше имя" value="<?php echo $last_name; ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-sm-7">
                ...
                <option value="Мужчина" <?php if ($gender == 'Мужчина') {echo "selected";}?> >Мужчина</option>
                <option value="Женщина" <?php if ($gender == 'Женщина') {echo "selected";}?>>Женщина</option>
                </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                <input type="email" value="<?php echo $email; ?>" name="email" class="form-control" id="email" placeholder="Введите почту">
                </div>
            </div>
            <div class="form-group row">
            <label for="course" class="col-sm-3 col-form-label">Курсы</label>
            <div class="col-sm-7">
                <select class="form-control" name="course" id="course">
                <option value="">Выберите курс</option>
                <option value="KKRIT" <?php if ($course == 'KKRIT') {echo "selected";}?>>ККРИТ</option>
                <option value="MBY" <?php if ($course == 'MBY') {echo "selected";}?>>МБУ</option>
                </select>
                </div>
            </div>
            <div class="form-group row">
